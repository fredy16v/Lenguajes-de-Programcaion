...
namespace ManejoPresupesto.Servicios
{
    public class ServicioReportes : IServicioReportes
    {
                ...
                int usuarioId, int mes, int año, dynamic ViewBag)
        {
            ...
            var transacciones =
                await repositorioTransacciones.ObtenerPorUsuarioId(parametros);
        ...
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
            var paremetro = new ParametrosObtenerTransaccionesPorUsuario 
            {
                UsuarioId = usuarioId,
                FechaInicio = fechaInicio,
                FechaFin = fechaFin,
            ...
            AsignarValoresAlViewBag(ViewBag, fechaInicio);
            var modelo = await repositorioTransacciones.ObtenerPorSemana(paremetro);
            return modelo;
        }
    }
}
